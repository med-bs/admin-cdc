          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <TextField
                ...
                variant="filled"
                type="text"
                label="Table To Listen"
                onBlur={handleBlur}
                onChange={handleChange}
                value={values.tableToListen}
                name="tableToListen"
                error={!!touched.tableToListen && !!errors.tableToListen}
                helperText={touched.tableToListen && errors.tableToListen}
                sx={{ gridColumn: "span 2" }}
              />
...
const checkoutSchema = yup.object().shape({
  ...
  tableToListen: yup.string().required("required"),
